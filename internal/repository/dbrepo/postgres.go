...
// InsertRoomRestriction inserts a romo restriction into the database
...
// SearchAvailabilityForAllRooms returns a slive of available rooms, if any, for given date range
