...
import (
	...
	"github.com/saim61/udemy_bed_and_breakfast/internal/driver"
	"github.com/saim61/udemy_bed_and_breakfast/internal/forms"
	"github.com/saim61/udemy_bed_and_breakfast/internal/helpers"
	...
	"github.com/saim61/udemy_bed_and_breakfast/internal/repository/dbrepo"
)
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	if len(rooms) == 0 {
		// no availability
		m.App.Session.Put(r.Context(), "error", "No rooms availabile for these dates!")
